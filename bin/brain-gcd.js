...
const generateBothNumber = () => {
    ...
    const numberTwo = isNumberOne ? getRandomNumber() * 2 : getRandomNumber() * 2 + 1;
...
while (correctAnswers < 3) {
    ...
    let userAnswer = readlineSync.question('Question: ' + numberOne + ' ' + numberTwo + '\n' + 'Your answer: ');
